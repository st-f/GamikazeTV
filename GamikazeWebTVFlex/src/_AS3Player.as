...
package
{
	...
	public class _AS3Player extends Canvas
	{
		// Member variables.
		...
		// CONSTANTS.
		private static const DEFAULT_VIDEO_ID:String="8ptA6fCNPeg";
		//private static const PLAYLIST_ID:String="PL0Kro0grO1E38K919quZb5P6xbAXRzDi3";
		private static const PLAYLIST_ID:String="8BCDD04DE8F771B2";
		...
		public function _AS3Player():void
		{
		...
		private function setupUi():void
		{
			...
			qualityComboBox.addEventListener(ListEvent.CHANGE, qualityComboBoxChangeHandler);
		...
		private function youtubeApiLoaderCompleteHandler(event:Event):void
		{
			...
			trace("player ready, cueing playlist : " + PLAYLIST_ID);
		}
		...
		{
			var request:URLRequest=new URLRequest(YOUTUBE_API_PREFIX + videoIdTextInput.text);
